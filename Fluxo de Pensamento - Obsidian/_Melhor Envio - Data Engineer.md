...
- Processar o arquivo de [[JSON|log]], extrair informações e salvá-las em um banco de dados.
- Estruturar esse [[000 Database Model|banco]] de forma relacional.
- Buscar a normalização desse banco de dados.
- Gerar um relatório para cada descrição abaixo, em formato csv: 
	- [[Request|Requisições]] por [[Tabela Consumidor|consumidor]];
		- Principais caracteristicas de [[Consumidor]] 
	- Requisições por [[Tabela Serviços|serviço]];
		- Principais caracteristicas de [[Serviço]] 
	- Tempo médio de request, proxy e kong por serviço.
		- Principais caracteristicas de [[Latencia]] 
